...
class EditRecurringTransactionCategoriesAdapter(val fragment: EditRecurringTransactionFragment, val context: Context, val categories: List<Category>): RecyclerView.Adapter<EditRecurringTransactionCategoriesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: EditRecurringTransactionCategoriesAdapter.ViewHolder, position: Int) {
