...
class AddRecurringIncomeCategoriesAdapter(val fragment: AddRecurringIncomeFragment, val context: Context, val categories: List<Category>): RecyclerView.Adapter<AddRecurringIncomeCategoriesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: AddRecurringIncomeCategoriesAdapter.ViewHolder, position: Int) {
