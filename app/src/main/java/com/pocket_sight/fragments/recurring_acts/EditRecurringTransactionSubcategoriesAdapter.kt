...
class EditRecurringTransactionSubcategoriesAdapter(val fragment: EditRecurringTransactionFragment, val context: Context, val subcategories: List<Subcategory>): RecyclerView.Adapter<EditRecurringTransactionSubcategoriesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: EditRecurringTransactionSubcategoriesAdapter.ViewHolder, position: Int) {
