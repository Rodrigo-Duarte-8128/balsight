...
class AddRecurringExpenseSubcategoriesAdapter(val fragment: AddRecurringExpenseFragment, val context: Context, val subcategories: List<Subcategory>): RecyclerView.Adapter<AddRecurringExpenseSubcategoriesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: AddRecurringExpenseSubcategoriesAdapter.ViewHolder, position: Int) {
