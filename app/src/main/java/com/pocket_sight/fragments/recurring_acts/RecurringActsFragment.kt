...
class RecurringActsFragment : Fragment() {
    ...
    private var fabIsExpanded = false
    ...
    private lateinit var recurringActsRv: RecyclerView
    lateinit var adapter: RecurringActsAdapter

    val uiScope = CoroutineScope(Dispatchers.Main + Job())

    private lateinit var displayedAccountButton: Button
    private var recurringDisplayedAccountNumber: Int? = null

    lateinit var accountsDatabase: AccountsDao
    private lateinit var recurringDisplayedAccountsDatabase: RecurringDisplayedAccountDao
