...
class AddIncomeSubcategoriesAdapter(val fragment: AddIncomeFragment, val context: Context, val subcategories: List<Subcategory>): RecyclerView.Adapter<AddIncomeSubcategoriesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: AddIncomeSubcategoriesAdapter.ViewHolder, position: Int) {
