...
class AddExpenseFragment: Fragment() {
    ...
    private lateinit var categoriesAdapter: AddExpenseCategoriesAdapter
    private lateinit var subcategoriesAdapter: AddExpenseSubcategoriesAdapter
    ...
    private fun addExpense(context: Context, view: View, valueEditText: EditText) {
        uiScope.launch {
