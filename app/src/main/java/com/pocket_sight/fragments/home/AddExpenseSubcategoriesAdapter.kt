...
class AddExpenseSubcategoriesAdapter(val fragment: AddExpenseFragment, val context: Context, val subcategories: List<Subcategory>): RecyclerView.Adapter<AddExpenseSubcategoriesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: AddExpenseSubcategoriesAdapter.ViewHolder, position: Int) {
