...
class AddIncomeCategoriesAdapter(val fragment: AddIncomeFragment, val context: Context, val categories: List<Category>): RecyclerView.Adapter<AddIncomeCategoriesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: AddIncomeCategoriesAdapter.ViewHolder, position: Int) {
